...
function mostrarModal() {
  ...
  // Limpia el contenido existente del checklist de productos
  const productosChecklist = document.getElementById('productosChecklist');
  productosChecklist.innerHTML = '';

  // Genera dinámicamente los campos según los elementos en el carrito
  carrito.forEach((item, index) => {
    const checkbox = document.createElement('input');
    checkbox.type = 'checkbox';
    checkbox.name = `productos[${index}]`;
    checkbox.value = item.title;
    checkbox.checked = true; // Puedes ajustar esto según tus necesidades
